...
if [ "$account" == "pulp" ]; then
	...
	$QC -v login F92-G4jA5CkT-eibTAtosv6ETVqhpzaGoVtdsTGM aCQJhOuPEooQGUV56VB7VH6CPFNCzwWZmhBQkA5i
...
elif [ "$account" == "regtest" ]; then
	$QC -v login lVgtk5xr03Oz_uvkzDtQ8LtpiEUWx5tGEDUZVg1y Kutyz7qxjZ_v_EySl49IsJw_Di06hvSLR3pRrH6P
else
